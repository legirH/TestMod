package com.legir.testmod.armor;
...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    GEM(TestMod.MOD_ID + ":gem", 25, new int[] { 2, 5, 6, 2 }, 18,
            SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F, () -> { return Ingredient.fromItems(RegistryHandler.GEM.get()); }, 0);
